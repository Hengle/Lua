...
public sealed class ObjectPool : MonoBehaviour
{
    ...
    {
        Recycle(obj, prefab, false);
    }

    private static void Recycle(GameObject obj, GameObject prefab, bool worldPositionStays)
    {
	...
	{
		CreatePool(prefab, initialPoolSize, false);
	}

	public static void CreatePool(GameObject prefab, int initialPoolSize, bool worldPositionStays)
	{
	...
	public static T Spawn<T>(T prefab, Transform parent, bool worldPositionStays, Vector3 position, Quaternion rotation) where T : Component
	{
		return Spawn(prefab.gameObject, parent, worldPositionStays, position, rotation).GetComponent<T>();
	}
	public static T Spawn<T>(T prefab, Vector3 position, Quaternion rotation) where T : Component
	{
		return Spawn(prefab.gameObject, null, false, position, rotation).GetComponent<T>();
	}
	public static T Spawn<T>(T prefab, Transform parent, bool worldPositionStays, Vector3 position) where T : Component
	{
		return Spawn(prefab.gameObject, parent, worldPositionStays, position, Quaternion.identity).GetComponent<T>();
	}
	public static T Spawn<T>(T prefab, Vector3 position) where T : Component
	{
		return Spawn(prefab.gameObject, null, false, position, Quaternion.identity).GetComponent<T>();
	}
	public static T Spawn<T>(T prefab, Transform parent, bool worldPositionStays) where T : Component
	{
		return Spawn(prefab.gameObject, parent, worldPositionStays, Vector3.zero, Quaternion.identity).GetComponent<T>();
	}
	public static T Spawn<T>(T prefab) where T : Component
	{
		return Spawn(prefab.gameObject, null, false, Vector3.zero, Quaternion.identity).GetComponent<T>();
	}
	public static GameObject Spawn(GameObject prefab, Transform parent, bool worldPositionStays, Vector3 position, Quaternion rotation)
	{
	...
	public static GameObject Spawn(GameObject prefab, Transform parent, bool worldPositionStays, Vector3 position)
	{
		return Spawn(prefab, parent, worldPositionStays, position, Quaternion.identity);
	}
	public static GameObject Spawn(GameObject prefab, Vector3 position, Quaternion rotation)
	{
		return Spawn(prefab, null, false, position, rotation);
	}
	public static GameObject Spawn(GameObject prefab, bool worldPositionStays, Transform parent)
	{
		return Spawn(prefab, parent, worldPositionStays, Vector3.zero, Quaternion.identity);
	}
	public static GameObject Spawn(GameObject prefab, Vector3 position)
	{
		return Spawn(prefab, null, false, position, Quaternion.identity);
	}
	public static GameObject Spawn(GameObject prefab)
	{
		return Spawn(prefab, null, false, Vector3.zero, Quaternion.identity);
	}
...
public static class ObjectPoolExtensions
{
	...
	public static T Spawn<T>(this T prefab, Transform parent, Vector3 position, Quaternion rotation, bool worldPositionStays) where T : Component
	{
		return ObjectPool.Spawn(prefab, parent, worldPositionStays, position, rotation);
	}
	public static T Spawn<T>(this T prefab, Transform parent, Vector3 position, Quaternion rotation) where T : Component
	{
		return ObjectPool.Spawn(prefab, parent, false, position, rotation);
	}
	public static T Spawn<T>(this T prefab, Vector3 position, Quaternion rotation) where T : Component
	{
		return ObjectPool.Spawn(prefab, null, false, position, rotation);
	}
	public static T Spawn<T>(this T prefab, Transform parent, Vector3 position, bool worldPositionStays) where T : Component
	{
		return ObjectPool.Spawn(prefab, parent, worldPositionStays, position, Quaternion.identity);
	}
	public static T Spawn<T>(this T prefab, Transform parent, Vector3 position) where T : Component
	{
		return ObjectPool.Spawn(prefab, parent, false, position, Quaternion.identity);
	}
	public static T Spawn<T>(this T prefab, Vector3 position) where T : Component
	{
		return ObjectPool.Spawn(prefab, null, false,  position, Quaternion.identity);
	}
	public static T Spawn<T>(this T prefab, Transform parent, bool worldPositionStays) where T : Component
	{
		return ObjectPool.Spawn(prefab, parent, worldPositionStays, Vector3.zero, Quaternion.identity);
	}
	public static T Spawn<T>(this T prefab, Transform parent) where T : Component
	{
		return ObjectPool.Spawn(prefab, parent, false, Vector3.zero, Quaternion.identity);
	}
	public static T Spawn<T>(this T prefab) where T : Component
	{
		return ObjectPool.Spawn(prefab, null, false, Vector3.zero, Quaternion.identity);
	}
	public static GameObject Spawn(this GameObject prefab, Transform parent, Vector3 position, Quaternion rotation, bool worldPositionStays)
	{
		return ObjectPool.Spawn(prefab, parent, worldPositionStays, position, rotation);
	}
	...
	public static GameObject Spawn(this GameObject prefab, Transform parent, Vector3 position, bool worldPositionStays)
	{
		return ObjectPool.Spawn(prefab, parent, worldPositionStays, position, Quaternion.identity);
	}
	...
	public static GameObject Spawn(this GameObject prefab, Transform parent, bool worldPositionStays)
	{
		return ObjectPool.Spawn(prefab, parent, worldPositionStays, Vector3.zero, Quaternion.identity);
	}
