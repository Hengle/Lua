...
public class PhysicsWrap
{
	...
	static int OverlapSphereNonAlloc(IntPtr L)
	{
		...
		if (count == 3)
		{
			...
			float arg1 = (float)LuaScriptMgr.GetNumber(L, 2);
			Collider[] arg2 = null;
			int o = Physics.OverlapSphereNonAlloc(arg0,arg1, arg2);
			LuaScriptMgr.Push(L, o);
			return 1;
		}
		else if (count == 4)
		{
			...
			Collider[] arg2 = null;
			int arg3 = (int)LuaScriptMgr.GetNumber(L, 4);
			int o = Physics.OverlapSphereNonAlloc(arg0,arg1, arg2, arg3);
			LuaScriptMgr.Push(L, o);
			return 1;
		}
		else if (count == 5)
		{
			...
			int arg3 = (int)LuaScriptMgr.GetNumber(L, 4);
			QueryTriggerInteraction arg4 = (QueryTriggerInteraction)LuaScriptMgr.GetNetObject(L, 5, typeof(QueryTriggerInteraction));
			int o = Physics.OverlapSphereNonAlloc(arg0,arg1, arg2, arg3,arg4);
			LuaScriptMgr.Push(L, o);
			return 1;
		}
		else
	...
	static int OverlapBoxNonAlloc(IntPtr L)
	{
		...
		if (count == 3)
		{
			...
			Vector3 arg1 = LuaScriptMgr.GetVector3(L, 2);
			Collider[] arg2 = null;
			int o = Physics.OverlapBoxNonAlloc(arg0,arg1, arg2);
			LuaScriptMgr.Push(L, o);
			return 1;
		}
		else if (count == 4)
		{
			...
			Collider[] arg2 = null;
			Quaternion arg3 = LuaScriptMgr.GetQuaternion(L, 4);
			int o = Physics.OverlapBoxNonAlloc(arg0,arg1, arg2, arg3);
			LuaScriptMgr.Push(L, o);
			return 1;
		}
		else if (count == 5)
		{
			...
			Quaternion arg3 = LuaScriptMgr.GetQuaternion(L, 4);
			int arg4 = (int)LuaScriptMgr.GetNumber(L, 5);
			int o = Physics.OverlapBoxNonAlloc(arg0,arg1, arg2, arg3,arg4);
			LuaScriptMgr.Push(L, o);
			return 1;
		}
		else if (count == 6)
		{
			...
			int arg4 = (int)LuaScriptMgr.GetNumber(L, 5);
			QueryTriggerInteraction arg5 = (QueryTriggerInteraction)LuaScriptMgr.GetNetObject(L, 6, typeof(QueryTriggerInteraction));
			int o = Physics.OverlapBoxNonAlloc(arg0,arg1, arg2, arg3,arg4,arg5);
			LuaScriptMgr.Push(L, o);
			return 1;
		}
		else
	...
	static int OverlapCapsuleNonAlloc(IntPtr L)
	{
		...
		if (count == 4)
		{
			...
			float arg2 = (float)LuaScriptMgr.GetNumber(L, 3);
			Collider[] arg3 = null;
			int o = Physics.OverlapCapsuleNonAlloc(arg0,arg1,arg2, arg3);
			LuaScriptMgr.Push(L, o);
			return 1;
		}
		else if (count == 5)
		{
			...
			Collider[] arg3 = null;
			int arg4 = (int)LuaScriptMgr.GetNumber(L, 5);
			int o = Physics.OverlapCapsuleNonAlloc(arg0,arg1,arg2, arg3, arg4);
			LuaScriptMgr.Push(L, o);
			return 1;
		}
		else if (count == 6)
		{
			...
			int arg4 = (int)LuaScriptMgr.GetNumber(L, 5);
			QueryTriggerInteraction arg5 = (QueryTriggerInteraction)LuaScriptMgr.GetNetObject(L, 6, typeof(QueryTriggerInteraction));
			int o = Physics.OverlapCapsuleNonAlloc(arg0,arg1,arg2, arg3, arg4,arg5);
			LuaScriptMgr.Push(L, o);
			return 1;
		}
		else
